...
class TestModelSetup < Test::Unit::TestCase 
	...
	def test_question_4_0_defines_classifier
		defines_classifier @context
	end

	def test_question_4_0_create_training_dataset	  
		can_create_training_dataset @context
	end

	def test_question_4_0_create_small_sample
		can_create_small_sample @context
	end

	def test_question_4_0_create_learner
		can_create_learner @context		
	end

	def test_question_4_0_evaluate_learner
		can_evaluate_learner @context		
	end

	def test_question_4_0_create_evaluation_set
		can_create_evaluation_set @context		
	end

	def test_question_4_0_run_on_dev_set
